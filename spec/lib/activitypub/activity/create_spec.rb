  ...
  describe '#perform' do
    context 'when fetching' do
      ...
      context 'with an unverifiable quote of a known post, with summary (CW) but no text' do
        let(:quoted_status) { Fabricate(:status, account: Fabricate(:account, domain: 'example.com'), quote_approval_policy: Status::InteractionPolicyConcern::QUOTE_POLICY_EXPLICIT_FLAG) }
