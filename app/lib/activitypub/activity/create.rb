...
class ActivityPub::Activity::Create < ActivityPub::Activity
  ...
  def fetch_and_verify_quote
    ...
    ActivityPub::QuoteRefetchScheduler.schedule_if_missing(@quote, @quote_uri, request_id: @options[:request_id], approval_uri: @quote_approval_uri)
  rescue Mastodon::RecursionLimitExceededError, Mastodon::UnexpectedResponseError, *Mastodon::HTTP_CONNECTION_ERRORS
    ActivityPub::QuoteRefetchScheduler.schedule(@quote, @quote_uri, request_id: @options[:request_id], approval_uri: @quote_approval_uri)
  end
