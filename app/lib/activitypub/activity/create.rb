...
class ActivityPub::Activity::Create < ActivityPub::Activity
  ...
  def fetch_and_verify_quote
    ...
    ActivityPub::QuoteRefetchScheduler.schedule_if_missing(@quote, @quote_uri, **quote_refetch_options)
  rescue Mastodon::RecursionLimitExceededError, Mastodon::UnexpectedResponseError, *Mastodon::HTTP_CONNECTION_ERRORS
    ActivityPub::QuoteRefetchScheduler.schedule(@quote, @quote_uri, **quote_refetch_options)
  end

  def quote_refetch_options
    { request_id: @options[:request_id], approval_uri: @quote_approval_uri, allow_legacy_quote_approval: @status_parser.legacy_quote? }
  end
