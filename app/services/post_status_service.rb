...
class PostStatusService < BaseService
  ...
  def attach_quote!(status)
    ...
    status.quote.accept! if @quoted_status.quote_accepted_without_request_for_account?(@account)
  end
  ...
  def postprocess_status!
    ...
    ActivityPub::QuoteRequestWorker.perform_async(@status.quote.id) if @status.quote&.quoted_status&.quote_request_needed?
  end
