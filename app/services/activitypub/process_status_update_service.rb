...
class ActivityPub::ProcessStatusUpdateService < BaseService
  ...
  def fetch_and_verify_quote!(quote, approval_uri, quote_uri)
    ...
    ActivityPub::QuoteRefetchScheduler.schedule_if_missing(quote, quote_uri, request_id: @request_id, approval_uri: approval_uri)
  rescue Mastodon::UnexpectedResponseError, *Mastodon::HTTP_CONNECTION_ERRORS
    ActivityPub::QuoteRefetchScheduler.schedule(quote, quote_uri, request_id: @request_id, approval_uri: approval_uri)
  end
