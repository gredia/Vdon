...
export const expandVirtualKemomimiRelayTimeline = ({ maxId, social, onlyMedia, showReblogs, showReplies, showQuotes } = {}) => expandTimeline(`virtual_kemomimi_relay${social ? ':social' : ''}${onlyMedia ? ':media' : ''}`, '/api/v1/timelines/virtual_kemomimi_relay', { max_id: maxId, social: !!social, only_media: !!onlyMedia, with_reblogs: showReblogs !== false, with_replies: showReplies !== false, with_quotes: showQuotes !== false });
...
export const fillVirtualKemomimiRelayTimelineGaps = ({ social, onlyMedia, showReblogs, showReplies, showQuotes } = {}) => fillTimelineGaps(`virtual_kemomimi_relay${social ? ':social' : ''}${onlyMedia ? ':media' : ''}`, '/api/v1/timelines/virtual_kemomimi_relay', { social: !!social, only_media: !!onlyMedia, with_reblogs: showReblogs !== false, with_replies: showReplies !== false, with_quotes: showQuotes !== false });
